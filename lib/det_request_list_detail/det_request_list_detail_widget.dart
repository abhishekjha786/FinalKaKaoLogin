...
class DetRequestListDetailWidget extends StatefulWidget {
  const DetRequestListDetailWidget({Key? key}) : super(key: key);

  @override
  _DetRequestListDetailWidgetState createState() =>
      _DetRequestListDetailWidgetState();
}

class _DetRequestListDetailWidgetState
    extends State<DetRequestListDetailWidget> {
