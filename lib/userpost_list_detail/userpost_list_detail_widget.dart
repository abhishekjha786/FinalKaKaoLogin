...
class UserpostListDetailWidget extends StatefulWidget {
  const UserpostListDetailWidget({Key? key}) : super(key: key);

  @override
  _UserpostListDetailWidgetState createState() =>
      _UserpostListDetailWidgetState();
}

class _UserpostListDetailWidgetState extends State<UserpostListDetailWidget> {
